...
const MyGroup = () => {
  ...
  // Safety timeout: if loading takes >5s, force-resolve to prevent infinite skeleton
  ...
  const headerControls = (
    <div className="flex items-center gap-2">
      ...
      {(teamAccess?.accessLevel === 'area_director' || accessLevel === 'corporate' || teamAccess?.accessLevel === 'mgmt_group_lead') && (
        <Button 

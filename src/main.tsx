...
if ("serviceWorker" in navigator) {
  ...
  navigator.serviceWorker.addEventListener("controllerchange", () => {
    ...
    notification.className = "fixed bottom-20 left-4 right-4 z-50 bg-primary text-primary-foreground px-4 py-3 rounded-lg shadow-lg flex items-center justify-between animate-in slide-in-from-bottom-4";

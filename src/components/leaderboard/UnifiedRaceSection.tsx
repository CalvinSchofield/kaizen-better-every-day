              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {/* Badge icons overlay */}
                    {badgeMap && badgeMap[entry.userId]?.map((badge, i) => (
                      <div
                        key={i}
                        className={cn(
                          "absolute",
                  ...
                  <div className={cn(
                    ...
                    {entry.pendingValue != null && entry.pendingValue > 0 && (activeMetric === 'fp_plus' || activeMetric === 'prmr') && (
                      <span className="text-warning text-[10px] ml-1 font-normal">
                        ⏳
                      </span>
                    )}
                  </div>
